    ...
    >
      ...
      <div className="grid">
        <div className="grid h-screen place-items-center">
          <div className="grid auto-cols-min place-items-center text-center">
        ...
        <div className="grid text-side relative z-[80] h-screen items-center gap-4 md:grid-cols-2">
          ...
          <div className="">
            ...
            <div className="text-side-body text-balance mt-4 max-w-xl text-xl font-normal text-sky-950">
